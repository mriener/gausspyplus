...
class GaussianDecomposer(object):
    ...
    def decompose(self,
                  ...
                  noise_spike_ranges: Optional[List] = None) -> Dict:
            ...
            try:
                ...
                if ncomps_ini > 0:
                    amps_ini, fwhms_ini, offsets_ini = split_params(
                        params=result['initial_parameters'],
                        ncomps=ncomps_ini)
                ...
                for key in ['best_fit_rchi2', 'best_fit_aicc', 'N_neg_res_peak', 'N_blended', 'log_gplus', 'pvalue',
                            'quality_control']:
