...
def test_decompose_cube_gausspy():
    ...
    decompose.decompose()
    with open(ROOT / "tests" / f"test_grs/gpy_decomposed/{filepath.stem}_g_fit_fin.pickle", "rb") as pfile:
    ...
    decompose.suffix = "_g+"
    decompose.decompose()
    with open(ROOT / "tests" / f"test_grs/gpy_decomposed/{filepath.stem}_g+_fit_fin.pickle", "rb") as pfile:
...
def test_spatial_fitting_phase_1():
    ...
    with open(ROOT / "tests" / f"test_grs/gpy_decomposed/{filepath.stem}_g+_fit_fin_sf-p1.pickle", "rb") as pfile:
...
def test_spatial_fitting_phase_2():
    ...
    with open(ROOT / "tests" / f"test_grs/gpy_decomposed/{filepath.stem}_g+_fit_fin_sf-p2.pickle", "rb") as pfile:
